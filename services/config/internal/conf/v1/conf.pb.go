...
func (x *Observability) GetMetricQuery() *Observability_MetricQuery {
	if x != nil {
...
type Server_Tls struct {
	...
	ClientCaPem string `protobuf:"bytes,4,opt,name=client_ca_pem,json=clientCaPem,proto3" json:"client_ca_pem,omitempty"`
	// 是否强制校验客户端证书(mTLS)。client_ca_pem 为空时打开它会启动失败
	RequireClientCert bool `protobuf:"varint,5,opt,name=require_client_cert,json=requireClientCert,proto3" json:"require_client_cert,omitempty"`
	unknownFields     protoimpl.UnknownFields
	sizeCache         protoimpl.SizeCache
}
...
func (x *Server_Tls) GetCertPem() string {
	if x != nil {
		return x.CertPem
	}
	return ""
...
func (x *Server_Tls) GetKeyPem() string {
	if x != nil {
		return x.KeyPem
	}
	return ""
...
func (x *Server_Tls) GetClientCaPem() string {
	if x != nil {
...
func (x *Server_Tls) GetRequireClientCert() bool {
	if x != nil {
...
func (*Server_Cors) Descriptor() ([]byte, []int) {
	return file_services_config_internal_conf_v1_conf_proto_rawDescGZIP(), []int{2, 2}
}
...
type Observability_MetricQuery struct {
	state protoimpl.MessageState `protogen:"open.v1"`
...
func (x *Observability_MetricQuery) Reset() {
	*x = Observability_MetricQuery{}
	mi := &file_services_config_internal_conf_v1_conf_proto_msgTypes[21]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *Observability_MetricQuery) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Observability_MetricQuery) ProtoMessage() {}

func (x *Observability_MetricQuery) ProtoReflect() protoreflect.Message {
	mi := &file_services_config_internal_conf_v1_conf_proto_msgTypes[21]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Observability_MetricQuery.ProtoReflect.Descriptor instead.
func (*Observability_MetricQuery) Descriptor() ([]byte, []int) {
	return file_services_config_internal_conf_v1_conf_proto_rawDescGZIP(), []int{4, 3}
}

func (x *Observability_MetricQuery) GetEndpoint() string {
	if x != nil {
		return x.Endpoint
	}
	return ""
...
func (x *Observability_MetricQuery) GetTimeout() *durationpb.Duration {
	if x != nil {
		return x.Timeout
	}
	return nil
...
func (x *Observability_MetricQuery) GetTls() *Observability_Tls {
	if x != nil {
		return x.Tls
	}
	return nil
...
func (*Observability_Tls) Descriptor() ([]byte, []int) {
	return file_services_config_internal_conf_v1_conf_proto_rawDescGZIP(), []int{4, 4}
}
...
func (x *Discovery_Consul_Check) Reset() {
	*x = Discovery_Consul_Check{}
	mi := &file_services_config_internal_conf_v1_conf_proto_msgTypes[25]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *Discovery_Consul_Check_TTL) Reset() {
	*x = Discovery_Consul_Check_TTL{}
	mi := &file_services_config_internal_conf_v1_conf_proto_msgTypes[26]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
const file_services_config_internal_conf_v1_conf_proto_rawDesc = "" +
	...
	"\x05level\x18\x02 \x01(\tB5\xbaH2r0R\x05debugR\x04infoR\x04warnR\x05errorR\x06dpanicR\x05panicR\x05fatalR\x05level\"\x8f\x05\n" +
	"\x06Server\x12&\n" +
	...
	"\x04cors\x18\x03 \x01(\v2\x14.conf.v1.Server.CorsR\x04cors\x12%\n" +
	"\x03tls\x18\x04 \x01(\v2\x13.conf.v1.Server.TlsR\x03tls\x1a\xa5\x01\n" +
	"\x03Tls\x12\x16\n" +
	"\x06enable\x18\x01 \x01(\bR\x06enable\x12\x19\n" +
	"\bcert_pem\x18\x02 \x01(\tR\acertPem\x12\x17\n" +
	"\akey_pem\x18\x03 \x01(\tR\x06keyPem\x12\"\n" +
	"\rclient_ca_pem\x18\x04 \x01(\tR\vclientCaPem\x12.\n" +
	"\x13require_client_cert\x18\x05 \x01(\bR\x11requireClientCert\x1a\xe6\x01\n" +
	"\x04HTTP\x12H\n" +
	...
	"\x06enable\x18\x04 \x01(\bR\x06enable\x12E\n" +
	"\fmetric_query\x18\x05 \x01(\v2\".conf.v1.Observability.MetricQueryR\vmetricQuery\x1a[\n" +
	"\x05Trace\x12$\n" +
	...
	"\xbaH\a\xaa\x01\x042\x02\b\x05R\fpingIntervalB\x9f\x01\n" +
	"\vcom.conf.v1B\tConfProtoP\x01ZHgithub.com/lens077/control-tower/services/config/internal/conf/v1;confv1\xa2\x02\x03CXX\xaa\x02\aConf.V1\xca\x02\aConf\\V1\xe2\x02\x13Conf\\V1\\GPBMetadata\xea\x02\bConf::V1b\x06proto3"
...
var file_services_config_internal_conf_v1_conf_proto_msgTypes = make([]protoimpl.MessageInfo, 27)
var file_services_config_internal_conf_v1_conf_proto_goTypes = []any{
	...
	(*Server_Tls)(nil),                          // 8: conf.v1.Server.Tls
	...
	(*Observability_MetricQuery)(nil),           // 21: conf.v1.Observability.MetricQuery
...
var file_services_config_internal_conf_v1_conf_proto_depIdxs = []int32{
	...
	9,  // 7: conf.v1.Server.http:type_name -> conf.v1.Server.HTTP
	10, // 8: conf.v1.Server.cors:type_name -> conf.v1.Server.Cors
	8,  // 9: conf.v1.Server.tls:type_name -> conf.v1.Server.Tls
	...
	21, // 15: conf.v1.Observability.metric_query:type_name -> conf.v1.Observability.MetricQuery
	...
	22, // 32: conf.v1.Observability.Metric.tls:type_name -> conf.v1.Observability.Tls
	22, // 33: conf.v1.Observability.Logging.tls:type_name -> conf.v1.Observability.Tls
	27, // 34: conf.v1.Observability.MetricQuery.timeout:type_name -> google.protobuf.Duration
	22, // 35: conf.v1.Observability.MetricQuery.tls:type_name -> conf.v1.Observability.Tls
