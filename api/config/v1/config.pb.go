...
type MachineTokenRole int32

const (
	MachineTokenRole_MACHINE_TOKEN_ROLE_UNSPECIFIED MachineTokenRole = 0 // 等价于 SERVICE
	MachineTokenRole_MACHINE_TOKEN_ROLE_SERVICE     MachineTokenRole = 1
	MachineTokenRole_MACHINE_TOKEN_ROLE_OPERATOR    MachineTokenRole = 2
)

// Enum value maps for MachineTokenRole.
var (
	MachineTokenRole_name = map[int32]string{
		0: "MACHINE_TOKEN_ROLE_UNSPECIFIED",
		1: "MACHINE_TOKEN_ROLE_SERVICE",
		2: "MACHINE_TOKEN_ROLE_OPERATOR",
	}
	MachineTokenRole_value = map[string]int32{
		"MACHINE_TOKEN_ROLE_UNSPECIFIED": 0,
		"MACHINE_TOKEN_ROLE_SERVICE":     1,
		"MACHINE_TOKEN_ROLE_OPERATOR":    2,
	}
)

func (x MachineTokenRole) Enum() *MachineTokenRole {
	p := new(MachineTokenRole)
	*p = x
	return p
}

func (x MachineTokenRole) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (MachineTokenRole) Descriptor() protoreflect.EnumDescriptor {
	return file_api_config_v1_config_proto_enumTypes[2].Descriptor()
}

func (MachineTokenRole) Type() protoreflect.EnumType {
	return &file_api_config_v1_config_proto_enumTypes[2]
}

func (x MachineTokenRole) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use MachineTokenRole.Descriptor instead.
func (MachineTokenRole) EnumDescriptor() ([]byte, []int) {
...
func (*ConfigTarget) ProtoMessage() {}

func (x *ConfigTarget) ProtoReflect() protoreflect.Message {
	mi := &file_api_config_v1_config_proto_msgTypes[3]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ConfigTarget.ProtoReflect.Descriptor instead.
func (*ConfigTarget) Descriptor() ([]byte, []int) {
	return file_api_config_v1_config_proto_rawDescGZIP(), []int{3}
}

func (x *ConfigTarget) GetNamespace() string {
	if x != nil {
		return x.Namespace
	}
	return ""
...
func (x *ConfigTarget) GetEnvironment() string {
	if x != nil {
		return x.Environment
	}
	return ""
...
func (x *ConfigTarget) GetKey() string {
	if x != nil {
		return x.Key
	}
	return ""
...
type ClientConnection struct {
	...
	ClientInstance       string                 `protobuf:"bytes,2,opt,name=client_instance,json=clientInstance,proto3" json:"client_instance,omitempty"`
	ClientVersion        string                 `protobuf:"bytes,3,opt,name=client_version,json=clientVersion,proto3" json:"client_version,omitempty"`
	Targets              []*ConfigTarget        `protobuf:"bytes,4,rep,name=targets,proto3" json:"targets,omitempty"`
	Watching             bool                   `protobuf:"varint,5,opt,name=watching,proto3" json:"watching,omitempty"`
	...
	LastWatchAt          *timestamppb.Timestamp `protobuf:"bytes,8,opt,name=last_watch_at,json=lastWatchAt,proto3" json:"last_watch_at,omitempty"`
...
func (x *ClientConnection) GetClientName() string {
	if x != nil {
		return x.ClientName
	}
	return ""
...
func (x *ClientConnection) GetClientInstance() string {
	if x != nil {
...
func (x *ClientConnection) GetClientVersion() string {
	if x != nil {
...
func (x *ClientConnection) GetTargets() []*ConfigTarget {
	if x != nil {
		return x.Targets
	}
	return nil
...
func (x *ClientConnection) GetWatching() bool {
	if x != nil {
		return x.Watching
	}
	return false
...
func (x *ClientConnection) GetConnectedAt() *timestamppb.Timestamp {
	if x != nil {
...
func (x *ClientConnection) GetLastReadAt() *timestamppb.Timestamp {
	if x != nil {
		return x.LastReadAt
	}
	return nil
...
func (x *ClientConnection) GetLastWatchAt() *timestamppb.Timestamp {
	if x != nil {
		return x.LastWatchAt
	}
	return nil
}

func (x *ClientConnection) GetDisconnectedAt() *timestamppb.Timestamp {
	if x != nil {
...
func (x *ClientConnection) GetLastDisconnectReason() string {
	if x != nil {
...
type ListClientConnectionsRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *ListClientConnectionsRequest) Reset() {
	*x = ListClientConnectionsRequest{}
	mi := &file_api_config_v1_config_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ListClientConnectionsRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ListClientConnectionsRequest) ProtoMessage() {}

func (x *ListClientConnectionsRequest) ProtoReflect() protoreflect.Message {
	mi := &file_api_config_v1_config_proto_msgTypes[5]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ListClientConnectionsRequest.ProtoReflect.Descriptor instead.
func (*ListClientConnectionsRequest) Descriptor() ([]byte, []int) {
	return file_api_config_v1_config_proto_rawDescGZIP(), []int{5}
}

type ListClientConnectionsResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
...
func (x *ListClientConnectionsResponse) Reset() {
	*x = ListClientConnectionsResponse{}
	mi := &file_api_config_v1_config_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ListClientConnectionsResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ListClientConnectionsResponse) ProtoMessage() {}

func (x *ListClientConnectionsResponse) ProtoReflect() protoreflect.Message {
	mi := &file_api_config_v1_config_proto_msgTypes[6]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ListClientConnectionsResponse.ProtoReflect.Descriptor instead.
func (*ListClientConnectionsResponse) Descriptor() ([]byte, []int) {
	return file_api_config_v1_config_proto_rawDescGZIP(), []int{6}
}

func (x *ListClientConnectionsResponse) GetConnections() []*ClientConnection {
	if x != nil {
...
func (x *RollbackRequest) Reset() {
	*x = RollbackRequest{}
	mi := &file_api_config_v1_config_proto_msgTypes[21]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*RollbackRequest) Descriptor() ([]byte, []int) {
	return file_api_config_v1_config_proto_rawDescGZIP(), []int{21}
}
...
func (x *RollbackResponse) Reset() {
	*x = RollbackResponse{}
	mi := &file_api_config_v1_config_proto_msgTypes[22]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*RollbackResponse) Descriptor() ([]byte, []int) {
	return file_api_config_v1_config_proto_rawDescGZIP(), []int{22}
}
...
func (x *WatchKeysRequest) Reset() {
	*x = WatchKeysRequest{}
	mi := &file_api_config_v1_config_proto_msgTypes[23]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*WatchKeysRequest) Descriptor() ([]byte, []int) {
	return file_api_config_v1_config_proto_rawDescGZIP(), []int{23}
}
...
func (x *WatchKeysResponse) Reset() {
	*x = WatchKeysResponse{}
	mi := &file_api_config_v1_config_proto_msgTypes[24]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*WatchKeysResponse) Descriptor() ([]byte, []int) {
	return file_api_config_v1_config_proto_rawDescGZIP(), []int{24}
}
...
type MachineTokenMeta struct {
	...
	Role              MachineTokenRole       `protobuf:"varint,10,opt,name=role,proto3,enum=config.v1.MachineTokenRole" json:"role,omitempty"`
	unknownFields     protoimpl.UnknownFields
	sizeCache         protoimpl.SizeCache
}
...
func (x *MachineTokenMeta) GetRole() MachineTokenRole {
	if x != nil {
		return x.Role
	}
	return MachineTokenRole_MACHINE_TOKEN_ROLE_UNSPECIFIED
}
...
type IssueMachineTokenRequest struct {
	...
	Role          MachineTokenRole `protobuf:"varint,5,opt,name=role,proto3,enum=config.v1.MachineTokenRole" json:"role,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *IssueMachineTokenRequest) GetRole() MachineTokenRole {
	if x != nil {
		return x.Role
	}
	return MachineTokenRole_MACHINE_TOKEN_ROLE_UNSPECIFIED
...
const file_api_config_v1_config_proto_rawDesc = "" +
	...
	"\tkey_count\x18\x03 \x01(\x05R\bkeyCount\"`\n" +
	"\fConfigTarget\x12\x1c\n" +
	"\tnamespace\x18\x01 \x01(\tR\tnamespace\x12 \n" +
	"\venvironment\x18\x02 \x01(\tR\venvironment\x12\x10\n" +
	"\x03key\x18\x03 \x01(\tR\x03key\"\x8a\x04\n" +
	"\x10ClientConnection\x12\x1f\n" +
	"\vclient_name\x18\x01 \x01(\tR\n" +
	"clientName\x12'\n" +
	"\x0fclient_instance\x18\x02 \x01(\tR\x0eclientInstance\x12%\n" +
	"\x0eclient_version\x18\x03 \x01(\tR\rclientVersion\x121\n" +
	"\atargets\x18\x04 \x03(\v2\x17.config.v1.ConfigTargetR\atargets\x12\x1a\n" +
	"\bwatching\x18\x05 \x01(\bR\bwatching\x12=\n" +
	...
	"lastReadAt\x12>\n" +
	"\rlast_watch_at\x18\b \x01(\v2\x1a.google.protobuf.TimestampR\vlastWatchAt\x12C\n" +
	"\x0fdisconnected_at\x18\t \x01(\v2\x1a.google.protobuf.TimestampR\x0edisconnectedAt\x124\n" +
	"\x16last_disconnect_reason\x18\n" +
	" \x01(\tR\x14lastDisconnectReason\"\x1e\n" +
	"\x1cListClientConnectionsRequest\"^\n" +
	"\x1dListClientConnectionsResponse\x12=\n" +
	"\vconnections\x18\x01 \x03(\v2\x1b.config.v1.ClientConnectionR\vconnections\"\x17\n" +
	...
	"\x05entry\x18\x02 \x01(\v2\x16.config.v1.ConfigEntryR\x05entry\"\xab\x03\n" +
	...
	"lastUsedAt\x12/\n" +
	"\x04role\x18\n" +
	" \x01(\x0e2\x1b.config.v1.MachineTokenRoleR\x04role\"q\n" +
	...
	"\x06tokens\x18\x01 \x03(\v2\x1b.config.v1.MachineTokenMetaR\x06tokens\"\xab\x02\n" +
	...
	"\x04note\x18\x04 \x01(\tB\b\xbaH\x05r\x03\x18\x80\x02R\x04note\x12/\n" +
	"\x04role\x18\x05 \x01(\x0e2\x1b.config.v1.MachineTokenRoleR\x04role\"b\n" +
	...
	"\x1aWATCH_EVENT_TYPE_HEARTBEAT\x10\x04*w\n" +
	"\x10MachineTokenRole\x12\"\n" +
	"\x1eMACHINE_TOKEN_ROLE_UNSPECIFIED\x10\x00\x12\x1e\n" +
	"\x1aMACHINE_TOKEN_ROLE_SERVICE\x10\x01\x12\x1f\n" +
	"\x1bMACHINE_TOKEN_ROLE_OPERATOR\x10\x022\xcb\b\n" +
	"\rConfigService\x12l\n" +
...
var file_api_config_v1_config_proto_enumTypes = make([]protoimpl.EnumInfo, 3)
...
var file_api_config_v1_config_proto_goTypes = []any{
	...
	(MachineTokenRole)(0),                 // 2: config.v1.MachineTokenRole
	(*ConfigEntry)(nil),                   // 3: config.v1.ConfigEntry
	(*ConfigRevision)(nil),                // 4: config.v1.ConfigRevision
	(*NamespaceInfo)(nil),                 // 5: config.v1.NamespaceInfo
	(*ConfigTarget)(nil),                  // 6: config.v1.ConfigTarget
	(*ClientConnection)(nil),              // 7: config.v1.ClientConnection
	(*ListClientConnectionsRequest)(nil),  // 8: config.v1.ListClientConnectionsRequest
	(*ListClientConnectionsResponse)(nil), // 9: config.v1.ListClientConnectionsResponse
	(*ListNamespacesRequest)(nil),         // 10: config.v1.ListNamespacesRequest
	(*ListNamespacesResponse)(nil),        // 11: config.v1.ListNamespacesResponse
	(*ListKeysRequest)(nil),               // 12: config.v1.ListKeysRequest
	(*ListKeysResponse)(nil),              // 13: config.v1.ListKeysResponse
	(*GetKeyRequest)(nil),                 // 14: config.v1.GetKeyRequest
	(*GetKeyResponse)(nil),                // 15: config.v1.GetKeyResponse
	(*PutKeyRequest)(nil),                 // 16: config.v1.PutKeyRequest
	(*PutKeyResponse)(nil),                // 17: config.v1.PutKeyResponse
	(*DeleteKeyRequest)(nil),              // 18: config.v1.DeleteKeyRequest
	(*DeleteKeyResponse)(nil),             // 19: config.v1.DeleteKeyResponse
	(*ListRevisionsRequest)(nil),          // 20: config.v1.ListRevisionsRequest
	(*ListRevisionsResponse)(nil),         // 21: config.v1.ListRevisionsResponse
	(*GetRevisionRequest)(nil),            // 22: config.v1.GetRevisionRequest
	(*GetRevisionResponse)(nil),           // 23: config.v1.GetRevisionResponse
	(*RollbackRequest)(nil),               // 24: config.v1.RollbackRequest
	(*RollbackResponse)(nil),              // 25: config.v1.RollbackResponse
	(*WatchKeysRequest)(nil),              // 26: config.v1.WatchKeysRequest
	(*WatchKeysResponse)(nil),             // 27: config.v1.WatchKeysResponse
	(*MachineTokenMeta)(nil),              // 28: config.v1.MachineTokenMeta
	(*ListMachineTokensRequest)(nil),      // 29: config.v1.ListMachineTokensRequest
	(*ListMachineTokensResponse)(nil),     // 30: config.v1.ListMachineTokensResponse
	(*IssueMachineTokenRequest)(nil),      // 31: config.v1.IssueMachineTokenRequest
	(*IssueMachineTokenResponse)(nil),     // 32: config.v1.IssueMachineTokenResponse
	(*RevokeMachineTokenRequest)(nil),     // 33: config.v1.RevokeMachineTokenRequest
	(*RevokeMachineTokenResponse)(nil),    // 34: config.v1.RevokeMachineTokenResponse
...
var file_api_config_v1_config_proto_depIdxs = []int32{
	...
	35, // 1: config.v1.ConfigEntry.created_at:type_name -> google.protobuf.Timestamp
	35, // 2: config.v1.ConfigEntry.updated_at:type_name -> google.protobuf.Timestamp
	0,  // 3: config.v1.ConfigRevision.format:type_name -> config.v1.ConfigFormat
	35, // 4: config.v1.ConfigRevision.created_at:type_name -> google.protobuf.Timestamp
	6,  // 5: config.v1.ClientConnection.targets:type_name -> config.v1.ConfigTarget
	35, // 6: config.v1.ClientConnection.connected_at:type_name -> google.protobuf.Timestamp
	35, // 7: config.v1.ClientConnection.last_read_at:type_name -> google.protobuf.Timestamp
	35, // 8: config.v1.ClientConnection.last_watch_at:type_name -> google.protobuf.Timestamp
	35, // 9: config.v1.ClientConnection.disconnected_at:type_name -> google.protobuf.Timestamp
	7,  // 10: config.v1.ListClientConnectionsResponse.connections:type_name -> config.v1.ClientConnection
	5,  // 11: config.v1.ListNamespacesResponse.namespaces:type_name -> config.v1.NamespaceInfo
	3,  // 12: config.v1.ListKeysResponse.entries:type_name -> config.v1.ConfigEntry
	3,  // 13: config.v1.GetKeyResponse.entry:type_name -> config.v1.ConfigEntry
	0,  // 14: config.v1.PutKeyRequest.format:type_name -> config.v1.ConfigFormat
	3,  // 15: config.v1.PutKeyResponse.entry:type_name -> config.v1.ConfigEntry
	4,  // 16: config.v1.ListRevisionsResponse.revisions:type_name -> config.v1.ConfigRevision
	4,  // 17: config.v1.GetRevisionResponse.revision:type_name -> config.v1.ConfigRevision
	3,  // 18: config.v1.RollbackResponse.entry:type_name -> config.v1.ConfigEntry
	1,  // 19: config.v1.WatchKeysResponse.type:type_name -> config.v1.WatchEventType
	3,  // 20: config.v1.WatchKeysResponse.entry:type_name -> config.v1.ConfigEntry
	35, // 21: config.v1.MachineTokenMeta.created_at:type_name -> google.protobuf.Timestamp
	35, // 22: config.v1.MachineTokenMeta.revoked_at:type_name -> google.protobuf.Timestamp
	35, // 23: config.v1.MachineTokenMeta.last_used_at:type_name -> google.protobuf.Timestamp
	2,  // 24: config.v1.MachineTokenMeta.role:type_name -> config.v1.MachineTokenRole
	28, // 25: config.v1.ListMachineTokensResponse.tokens:type_name -> config.v1.MachineTokenMeta
	2,  // 26: config.v1.IssueMachineTokenRequest.role:type_name -> config.v1.MachineTokenRole
	28, // 27: config.v1.IssueMachineTokenResponse.meta:type_name -> config.v1.MachineTokenMeta
	8,  // 28: config.v1.ConfigService.ListClientConnections:input_type -> config.v1.ListClientConnectionsRequest
	10, // 29: config.v1.ConfigService.ListNamespaces:input_type -> config.v1.ListNamespacesRequest
	12, // 30: config.v1.ConfigService.ListKeys:input_type -> config.v1.ListKeysRequest
	14, // 31: config.v1.ConfigService.GetKey:input_type -> config.v1.GetKeyRequest
	16, // 32: config.v1.ConfigService.PutKey:input_type -> config.v1.PutKeyRequest
	18, // 33: config.v1.ConfigService.DeleteKey:input_type -> config.v1.DeleteKeyRequest
	20, // 34: config.v1.ConfigService.ListRevisions:input_type -> config.v1.ListRevisionsRequest
	22, // 35: config.v1.ConfigService.GetRevision:input_type -> config.v1.GetRevisionRequest
	24, // 36: config.v1.ConfigService.Rollback:input_type -> config.v1.RollbackRequest
	26, // 37: config.v1.ConfigService.WatchKeys:input_type -> config.v1.WatchKeysRequest
	29, // 38: config.v1.ConfigService.ListMachineTokens:input_type -> config.v1.ListMachineTokensRequest
	31, // 39: config.v1.ConfigService.IssueMachineToken:input_type -> config.v1.IssueMachineTokenRequest
	33, // 40: config.v1.ConfigService.RevokeMachineToken:input_type -> config.v1.RevokeMachineTokenRequest
	9,  // 41: config.v1.ConfigService.ListClientConnections:output_type -> config.v1.ListClientConnectionsResponse
	11, // 42: config.v1.ConfigService.ListNamespaces:output_type -> config.v1.ListNamespacesResponse
	13, // 43: config.v1.ConfigService.ListKeys:output_type -> config.v1.ListKeysResponse
	15, // 44: config.v1.ConfigService.GetKey:output_type -> config.v1.GetKeyResponse
	17, // 45: config.v1.ConfigService.PutKey:output_type -> config.v1.PutKeyResponse
	19, // 46: config.v1.ConfigService.DeleteKey:output_type -> config.v1.DeleteKeyResponse
	21, // 47: config.v1.ConfigService.ListRevisions:output_type -> config.v1.ListRevisionsResponse
	23, // 48: config.v1.ConfigService.GetRevision:output_type -> config.v1.GetRevisionResponse
	25, // 49: config.v1.ConfigService.Rollback:output_type -> config.v1.RollbackResponse
	27, // 50: config.v1.ConfigService.WatchKeys:output_type -> config.v1.WatchKeysResponse
	30, // 51: config.v1.ConfigService.ListMachineTokens:output_type -> config.v1.ListMachineTokensResponse
	32, // 52: config.v1.ConfigService.IssueMachineToken:output_type -> config.v1.IssueMachineTokenResponse
	34, // 53: config.v1.ConfigService.RevokeMachineToken:output_type -> config.v1.RevokeMachineTokenResponse
