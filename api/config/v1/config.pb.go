...
var file_api_config_v1_config_proto_goTypes = []any{
	...
	(*ConfigTarget)(nil),                  // 5: config.v1.ConfigTarget
	(*ClientConnection)(nil),              // 6: config.v1.ClientConnection
	(*ListClientConnectionsRequest)(nil),  // 7: config.v1.ListClientConnectionsRequest
	(*ListClientConnectionsResponse)(nil), // 8: config.v1.ListClientConnectionsResponse
	(*ListNamespacesRequest)(nil),         // 9: config.v1.ListNamespacesRequest
	(*ListNamespacesResponse)(nil),        // 10: config.v1.ListNamespacesResponse
	(*ListKeysRequest)(nil),               // 11: config.v1.ListKeysRequest
	(*ListKeysResponse)(nil),              // 12: config.v1.ListKeysResponse
	(*GetKeyRequest)(nil),                 // 13: config.v1.GetKeyRequest
	(*GetKeyResponse)(nil),                // 14: config.v1.GetKeyResponse
	(*PutKeyRequest)(nil),                 // 15: config.v1.PutKeyRequest
	(*PutKeyResponse)(nil),                // 16: config.v1.PutKeyResponse
	(*DeleteKeyRequest)(nil),              // 17: config.v1.DeleteKeyRequest
	(*DeleteKeyResponse)(nil),             // 18: config.v1.DeleteKeyResponse
	(*ListRevisionsRequest)(nil),          // 19: config.v1.ListRevisionsRequest
	(*ListRevisionsResponse)(nil),         // 20: config.v1.ListRevisionsResponse
	(*GetRevisionRequest)(nil),            // 21: config.v1.GetRevisionRequest
	(*GetRevisionResponse)(nil),           // 22: config.v1.GetRevisionResponse
	(*RollbackRequest)(nil),               // 23: config.v1.RollbackRequest
...
var file_api_config_v1_config_proto_depIdxs = []int32{
	...
	2,  // 13: config.v1.GetKeyResponse.entry:type_name -> config.v1.ConfigEntry
	0,  // 14: config.v1.PutKeyRequest.format:type_name -> config.v1.ConfigFormat
	2,  // 15: config.v1.PutKeyResponse.entry:type_name -> config.v1.ConfigEntry
	3,  // 16: config.v1.ListRevisionsResponse.revisions:type_name -> config.v1.ConfigRevision
	3,  // 17: config.v1.GetRevisionResponse.revision:type_name -> config.v1.ConfigRevision
